...
class chemical:
  ...
  def armazenar_elemento(self):
    ...
    with open('Dados do Elemento.txt', 'a') as cadastro:
      cadastro.write('\n NOME: {} \n NÚMERO ATÔMICO: {}\n VOLUME ATÔMICO: {}\n QUANTIDADE DE ÁTOMOS: {}\n BLOCO: {} \n CAS - NUMERO DE IDENTIFICAÇÃO: {} \n ELETRONS: {} \n DESCRIÇÃO: {} \n GRUPO: {} \n ID DO GRUPO: {}\n NEUTRONS: {} \n MASSA: {} \n PERIODO: {} \n ABUNDÂNCIA: {} \n COR DO ELEMENTO: {} \n DENSIDADE: {} \n ELETROCONFIGURAÇÃO: {} \n NOME DO DESCOBRIDOR: {} \n LOCAL DE DESCOBERTA: {} \n ANO DE DESCOBERTA {} \n'
        .format(self.name_elem, self.atomic_num, self.atomic_vol,
                self.atomic_weight, self.block, self.cas, self.electrons,
                self.description, self.group, self.group_id, self.neutrons,
                self.mass, self.period, self.abundance_crust, self.cpk_color,
  ...
  def elemento(self):  #FRAME TELA2
    try:
      ...
      self.cor_cpk.config(text=f'             ',bg=f'{self.cpk_color}')
    except:
...
#___ ______________________________________________________________
  ...
  def __init__(self, master):
    ...
    self.ap_simb.place(x=20, y=100)

    self.cor_cpk = Label(self.tela2, text='COR DO ELEMENTO', bg='#D8E1EE')
    self.cor_cpk.place(x=20, y=140)
